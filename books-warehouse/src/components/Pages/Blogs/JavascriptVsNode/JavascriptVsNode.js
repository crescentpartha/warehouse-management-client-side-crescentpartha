...
const JavascriptVsNode = () => {
    return (
        <div className='col-span-4 sm:col-span-5 h-auto m-16'>
            <img className='w-full border rounded ' src={js_node} alt="JavaScript Vs Nodejs" />
            <div className='text-start'>
                <h1 className='text-4xl py-4 font-semibold'>What is the difference between JavaScript and Nodejs?</h1>
                <div>
                    <h2 className='text-3xl py-4'>Introduction To JavaScript</h2>
                ...
                <div>
                    <h2 className='text-3xl py-4'>Introduction To Node.Js</h2>
                ...
                <div>
                    <h2 className='text-3xl py-4'>JavaScript Vs Nodejs: The Key Differences</h2>
